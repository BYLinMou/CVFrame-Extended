...
def main():
    ...
    for index, row in df.iterrows():
        ...
        # 建構輸出路徑
        output_video_C_path = os.path.join(output_videos_dir, f"{video_C_name}")
        output_video_L_path = os.path.join(output_videos_dir, f"{video_L_name}")
